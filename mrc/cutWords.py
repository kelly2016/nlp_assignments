...
def get_stopwords(stopwordsFile = '/Users/henry/Documents/application/nlp_assignments/data/stopword_ltp.txt'):
...
class Analyzer(object):
    ANALYZERS = Enum('Analyzer', ('Jieba',  'nltk'))
    """
    ...
    def __init__(self,type,replaceP=True,useStopwords = False,userdict = None):
        ...
        elif type == Analyzer.ANALYZERS.nltk:
            self.analyzer = nltk
    ...
    def cut(self,string):
        ...
        for sen in sens:
            if self.type == Analyzer.ANALYZERS.Jieba:
                ...
                stemmer = snowballstemmer.stemmer('english');  # 参数是选择的语言
