...
# 获取项目根目录
root =    os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + os.sep + 'data' + os.sep+ 'AutoMaster' + os.sep
...
# 2. pad oov处理后的数据
train_x_pad_path = os.path.join(root, 'data', 'AutoMaster_Train_X.csv')
train_y_pad_path = os.path.join(root, 'data', 'AutoMaster_Train_Y.csv')
test_x_pad_path = os.path.join(root, 'data', 'AutoMaster_Test_X.csv')
...
# 模型保存文件夹
checkpoint_dir = os.path.join(root, 'data', 'checkpoints', 'training_checkpoints_pgn')
