...
python -u ${PYTHONPATH}/run_classifier.py \
                   ...
                   --checkpoints /Users/henry/Documents/application/nlp_assignments/data/KnowledgeLabel/corpus2/chnsenticorp/output/checkpoints \
                   --save_steps 10 \
                   --weight_decay  0.01 \
                   ...
                   --num_labels 2 \
                   --random_seed 1
                   --test_save /Users/henry/Documents/application/nlp_assignments/data/KnowledgeLabel/corpus2/chnsenticorp/checkpoints/test_result/